...
Neo Brutal gives the Odoo 17 backend bold outlines, solid shadows, seven
...
* Tested with Odoo 17 Community, installed on a self-hosted server.
...
* Discuss, Calendar, CRM, Project and standard graph/pivot views are checked
  on Odoo 17 Community. Specialized editors, Studio, spreadsheets, custom charts and
